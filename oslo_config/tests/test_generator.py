...
class GeneratorTestCase(base.BaseTestCase):
    ...
    opts = {
        ...
        'deprecated_opt_with_deprecated_since': cfg.BoolOpt(
            'tune_in', deprecated_for_removal=True, deprecated_since='13.0'
        ),
        ...
        'opt_with_DeprecatedOpt': cfg.BoolOpt(
            ...
            deprecated_opts=[cfg.DeprecatedOpt('foo-bar', group='deprecated')],
        ),
        # Unknown Opt default must be a string
        'unknown_type': cfg.Opt(
            'unknown_opt',
            default='123',
            help='unknown',
            type=types.String(type_name='unknown type'),
        ),
        'str_opt': cfg.StrOpt('str_opt', default='foo bar', help='a string'),
        'str_opt_sample_default': cfg.StrOpt(
            'str_opt', default='fooishbar', help='a string'
        ),
        'str_opt_with_space': cfg.StrOpt(
            'str_opt', default='  foo bar  ', help='a string with spaces'
        ),
        'str_opt_multiline': cfg.StrOpt(
            'str_opt', default='foo\nbar\nbaz', help='a string with newlines'
        ),
        'bool_opt': cfg.BoolOpt('bool_opt', default=False, help='a boolean'),
        'int_opt': cfg.IntOpt(
            'int_opt', default=10, min=1, max=20, help='an integer'
        ),
        'int_opt_min_0': cfg.IntOpt(
            'int_opt_min_0', default=10, min=0, max=20, help='an integer'
        ),
        ...
        'list_opt_with_bounds': cfg.ListOpt(
            'list_opt_with_bounds',
            default=['1', '2', '3'],
            help='a list',
            bounds=True,
        ),
        'list_opt_single': cfg.ListOpt(
            'list_opt_single', default='1', help='a list'
        ),
        'list_int_opt': cfg.ListOpt(
            'list_int_opt', default=[1, 2, 3], help='a list'
        ),
        'dict_opt': cfg.DictOpt(
            'dict_opt', default={'1': 'yes', '2': 'no'}, help='a dict'
        ),
        'ip_opt': cfg.IPOpt(
            'ip_opt', default='127.0.0.1', help='an ip address'
        ),
        'port_opt': cfg.PortOpt('port_opt', default=80, help='a port'),
        'hostname_opt': cfg.HostnameOpt(
            'hostname_opt', default='compute01.nova.site1', help='a hostname'
        ),
        'uri_opt': cfg.URIOpt(
            'uri_opt', default='http://example.com', help='a URI'
        ),
        'multi_opt': cfg.MultiStrOpt(
            'multi_opt', default=['1', '2', '3'], help='multiple strings'
        ),
        'multi_opt_none': cfg.MultiStrOpt(
            'multi_opt_none', help='multiple strings'
        ),
        'multi_opt_empty': cfg.MultiStrOpt(
            'multi_opt_empty', default=[], help='multiple strings'
        ),
        'multi_opt_sample_default': cfg.MultiStrOpt(
            'multi_opt',
            default=['1', '2', '3'],
            sample_default=['5', '6'],
            help='multiple strings',
        ),
        'string_type_with_bad_default': cfg.Opt(
        ...
        'custom_type_name': cfg.Opt(
            'custom_opt_type',
            type=types.Integer(type_name='port number'),
            default=5511,
            help='this is a port',
        ),
    }
...
''',
        ...
        (
            'group',
            dict(
                opts=[('test', [(groups['group1'], [opts['foo']])])],
                expected='''[DEFAULT]
...
''',
        ...
        (
            ...
            dict(
                opts=[('test', [(None, [opts['long_help_pre']])])],
                wrap_width=70,
                expected='''[DEFAULT]
...
''',
        ...
        (
            'choices_opt',
            dict(
                opts=[('test', [(None, [opts['choices_opt']])])],
                expected="""[DEFAULT]
        ...
        (
            ...
            dict(
                opts=[
                    (
                        'test',
                        [(groups['foo'], [opts['deprecated_reason_opt']])],
                    )
                ],
                expected='''[DEFAULT]
...
''',
        ...
        (
            'unknown_type',
            dict(
                opts=[('test', [(None, [opts['unknown_type']])])],
                expected='''[DEFAULT]
...
''',
        ...
        (
            'str_opt_with_space',
            dict(
                opts=[('test', [(None, [opts['str_opt_with_space']])])],
                expected='''[DEFAULT]
...
''',
        ...
        (
            'str_opt_multiline',
            dict(
                opts=[('test', [(None, [opts['str_opt_multiline']])])],
                expected='''[DEFAULT]
...
''',
        ...
        (
            'int_opt_min_0',
            dict(
                opts=[('test', [(None, [opts['int_opt_min_0']])])],
                expected='''[DEFAULT]
...
''',
        ...
        (
            'int_opt_max_0',
            dict(
                opts=[('test', [(None, [opts['int_opt_max_0']])])],
                expected='''[DEFAULT]
...
''',
        ...
        (
            'list_opt_with_bounds',
            dict(
                opts=[('test', [(None, [opts['list_opt_with_bounds']])])],
                expected='''[DEFAULT]
...
''',
        ...
        (
            'list_opt_single',
            dict(
                opts=[('test', [(None, [opts['list_opt_single']])])],
                expected='''[DEFAULT]
...
''',
        ...
        (
            'list_int_opt',
            dict(
                opts=[('test', [(None, [opts['list_int_opt']])])],
                expected='''[DEFAULT]
...
''',
        ...
        (
            'hostname_opt',
            dict(
                opts=[('test', [(None, [opts['hostname_opt']])])],
                expected='''[DEFAULT]
...
''',
        ...
        (
            'multi_opt_none',
            dict(
                opts=[('test', [(None, [opts['multi_opt_none']])])],
                expected='''[DEFAULT]
...
''',
        ...
        (
            'multi_opt_empty',
            dict(
                opts=[('test', [(None, [opts['multi_opt_empty']])])],
                expected='''[DEFAULT]
...
''',
        ...
        (
            ...
            dict(
                opts=[('test', [(None, [opts['str_opt_sample_default']])])],
                expected='''[DEFAULT]
...
''',
        ...
        (
            'native_str_type',
            dict(
                opts=[('test', [(None, [opts['native_str_type']])])],
                expected='''[DEFAULT]
...
''',
        ...
        (
            'native_int_type',
            dict(
                opts=[('test', [(None, [opts['native_int_type']])])],
                expected='''[DEFAULT]
...
''',
        ...
        (
            'native_float_type',
            dict(
                opts=[('test', [(None, [opts['native_float_type']])])],
                expected='''[DEFAULT]
...
''',
        ...
        (
            ...
            dict(
                opts=[('test', [(None, [opts['multi_opt_sample_default']])])],
                expected='''[DEFAULT]
...
''',
        ...
        (
            'custom_type_name',
            dict(
                opts=[('test', [(None, [opts['custom_type_name']])])],
                expected='''[DEFAULT]
...
''',
        ...
        (
            'custom_type',
            dict(
                opts=[('test', [(None, [opts['custom_type']])])],
                expected='''[DEFAULT]
...
''',
        ...
        (
            ...
            dict(
                opts=[
                    ('test', [(None, [opts['string_type_with_bad_default']])])
                ],
                expected='''[DEFAULT]
...
''',
        ...
        (
            ...
            dict(
                opts=[('test', [(None, [opts['opt_with_DeprecatedOpt']])])],
                expected='''[DEFAULT]
...
class DriverOptionTestCase(base.BaseTestCase):
    ...
    def test_driver_option(
        self, mock_log, raw_opts_loader, driver_opts_loader
    ):
        group = cfg.OptGroup(
            name='test_group',
            title='Test Group',
        ...
        self.assertEqual(
            ['foo', 'bar', 'd1-foo', 'd2-foo'], found_option_names
        )
        self.assertEqual(
            {'d1': ['d1-foo'], 'd2': ['d2-foo']},
...
class MachineReadableGeneratorTestCase(base.BaseTestCase):
    ...
    content_scenarios = [
        ...
        (
            'long_help',
            dict(
                opts=[('test', [(None, [all_opts['long_help']])])],
                expected={
                    'deprecated_options': {},
                    'generator_options': GENERATOR_OPTS,
                    'options': {
        ...
        (
            'long_help_pre',
            dict(
                opts=[('test', [(None, [all_opts['long_help_pre']])])],
                expected={
                    'deprecated_options': {},
                    'generator_options': GENERATOR_OPTS,
                    'options': {
                            ...
                            'opts': [
                                {
                                    ...
                                    'deprecated_since': None,
                                    'dest': 'long_help_pre',
                                    'help': all_opts['long_help_pre'].help,
                                    'max': None,
                                    'metavar': None,
                                    'min': None,
                                    'mutable': False,
        ...
        (
            ...
            dict(
                opts=[
                    ('test', [(None, [all_opts['opt_with_DeprecatedOpt']])])
                ],
                expected={
                    'deprecated_options': {
                        'deprecated': [
        ...
        (
            'choices_opt',
            dict(
                opts=[('test', [(None, [all_opts['choices_opt']])])],
                expected={
                    'deprecated_options': {},
                    'generator_options': GENERATOR_OPTS,
                    'options': {
        ...
        (
            'int_opt',
            dict(
                opts=[('test', [(None, [all_opts['int_opt']])])],
                expected={
                    'deprecated_options': {},
                    'generator_options': GENERATOR_OPTS,
                    'options': {
        ...
        (
            'group_help',
            dict(
                opts=[('test', [(all_groups['group1'], [all_opts['foo']])])],
                expected={
                    'deprecated_options': {},
                    'generator_options': GENERATOR_OPTS,
                    'options': {
    ...
    def test_generate(self, raw_opts_loader):
        ...
        self.assertEqual(
            self.expected,
            generator._generate_machine_readable_data(test_groups, self.conf),
        )
...
class IgnoreDoublesTestCase(base.BaseTestCase):
    ...
    def test_cleanup_opts_dup_namespace_groups_opts(self):
        ...
        e = [
            ("namespace1", [("group1", self.opts), ("group2", self.opts)]),
            ("namespace2", [("group1", self.opts), ("group2", self.opts)]),
        ]
        self.assertEqual(e, generator._cleanup_opts(o))
...
class GeneratorAdditionalTestCase(base.BaseTestCase):
    opts = [
        cfg.StrOpt('foo', help='foo option', default='fred'),
        cfg.StrOpt('bar', help='bar option'),
        cfg.StrOpt('foo_bar', help='foobar'),
        cfg.StrOpt('str_opt', help='a string'),
        cfg.BoolOpt('bool_opt', help='a boolean'),
    ...
    def test_get_groups_empty_ns(self):
        ...
        self.assertEqual(
            {'DEFAULT': {'object': None, 'namespaces': []}}, groups
        )
    ...
    def test_get_groups_multiple_ns(self):
        config = [
            ("namespace1", [("beta", self.opts), ("alpha", self.opts)]),
